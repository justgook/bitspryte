...
- Downstream SMGUI additions: native Panel Forms with per-side padding, renderer-owned backgrounds, and transparent content, reusable normal/focused nine-slices, the generated Catppuccin named style atlas, and positive integer nearest-neighbor loading scales for skin/style/icon graphics
